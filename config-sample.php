...
//-- MySQL Settings --//
/** MySQL database name */
$db_name = 'popmedi2_phpmelody_pop';

/** MySQL database username */
$db_user = 'popmedi2_melody';

/** MySQL database password */
$db_pass = 'SuperCali123!';

/** MySQL hostname */
$db_host = 'localhost';

// Full URL without any trailing slash (e.g http://www.example.com)
define('_URL', 'http://wp9.temp.domains/~popmedi2/melody');	
...
define('_CUSTOMER_ID', 'PSc54a25452a1');	
